...
const Rewards = () => {
  ...
  return (
    <View style={styles.container}>
      <View>
        <Text style={[styles.text, {alignSelf: 'center'}]}>Reward Points</Text>
      </View>
      <ImageBackground
        source={{
          uri: 'https://previews.123rf.com/images/lightwise/lightwise1201/lightwise120100160/12082766-winning-success-gold-cup-award-in-a-dynamic-forced-perspective-camera-angle-and-a-golden-star-burst.jpg',
        }}
